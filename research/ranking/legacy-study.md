# Archived pre-v2 research account

This is the historical research narrative from commit bfb1308, retained for provenance.
**Do not treat its whole-corpus production estimates as validated.** The dense replay
included the evaluated papers in author memory; reference availability and metadata
versions were reconstructed later. Its claimed 0% newcomer rate is therefore not proof
of adequate historical coverage. The current [review](README.md) supersedes those
interpretations. The original reported numbers below have not been silently rewritten.
